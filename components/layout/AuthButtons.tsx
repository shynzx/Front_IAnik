  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        className="px-4 py-2.5 rounded-xl border border-white/[0.18] text-white/75 bg-transparent text-sm cursor-pointer whitespace-nowrap hover:bg-white/[0.05] transition-colors"
      >
      ...
      <button
        ...
        className={`px-4 py-2.5 rounded-xl text-sm cursor-pointer whitespace-nowrap transition-colors ${
          userName
